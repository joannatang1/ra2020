...
jsPsych.plugins['two-stims'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<div class="jspsych-same-different-stimulus">'+trial.stimuli[0]+'</div>' + '<div class="jspsych-same-different-stimulus">'+trial.stimuli[1]+'</div>';
    ...
    function showSecondStim() {
      ...
      if (trial.second_stim_duration > 0) {
        jsPsych.pluginAPI.setTimeout(function() {
          display_element.querySelector('.jspsych-same-different-stimulus').style.visibility = 'visible';
